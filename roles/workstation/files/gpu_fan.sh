...
# gpu_fan.sh  This script will enable or disable fixed gpu fan speed
#
...
#
# Modified to omit non-functional version check
# Tested on Red Hat Enterprise Linux 7.3 with driver 375.39
